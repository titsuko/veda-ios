document.addEventListener('DOMContentLoaded', () => {
    const createModal = createSimpleModal('createCategoryModal', 'openCreateModalBtn');
    const editModal = createEditModal('editCategoryModal', 'editCategoryForm');
    const deleteModal = createDeleteModal('deleteConfirmModal', 'deleteCategoryForm');
...
function createEditModal(modalId, formId) {
    ...
    const open = (data) => {
        form.action = `/admin/category/${data.id}/update`;
